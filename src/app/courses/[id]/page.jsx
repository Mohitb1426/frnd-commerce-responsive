...
function page() {
  ...
  const { isCourseDetailsLoading, courseDataById } = useSelector((state) => state?.coursesReducer);
  ...
  return (
    <div style={{ background: "#0b1629" }}>
      ...
      {courseDataById?.course?.courseContent?.length > 0 &&
        <CourseContentComponent courseContent={courseDataById?.course?.courseContent} />
      }
      <div style={{ marginTop: "80px" }} />
      ...
      {courseDataById?.course?.isCertificateIncluded && <>
        <div style={{ marginTop: "80px" }} />
        <CertificateCoursesSection courseName={courseDataById?.course?.title} certificateDetails={courseDataById?.course?.certificate} />
      </>}
      <div style={{ marginTop: "80px" }} />
      <InstructorCoursesSection courseDetails={courseDataById} />
      <div style={{ marginTop: "80px" }} />
      {courseDataById?.course?.reviews?.length > 0 && <Testimonials allReviews={courseDataById?.course?.reviews} />}
      <div style={{ marginTop: "80px" }} />
